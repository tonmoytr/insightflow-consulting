              ...
              <div className="space-y-8">
                ...
                <div className="border-t border-gray-200 pt-8">
                  <div className="flex flex-col justify-center gap-4 sm:flex-row">
                    <Link
                      href="/contact"
                      className="rounded-xl bg-indigo-600 px-8 py-4 text-center font-semibold text-white hover:bg-indigo-700"
                    >
                    ...
                    <button
                      type="button"
                      onClick={resetForm}
                      className="rounded-xl border border-gray-300 px-8 py-4 text-center font-semibold text-gray-700 hover:bg-gray-50"
                    >
